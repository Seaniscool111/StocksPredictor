# AAPLStockPredictor
## Description
In this project, I analyzed the stock, Apple Inc. (AAPL), trying to predict the closing stock using Python and Machine Learning (LSTM). Using historical market data from Yahoo Finance and a Long Short-Term Mempory (LSTM) neural network, the model learns patterns in price movement, volatility and momentum to forecase future stock trends.
